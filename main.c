...
void cudaUpdateGrid() {
    ...
    cudaStatus = cudaMemset(d_cycle_count, 0, sizeof(int));
    if (cudaStatus != cudaSuccess) {
        printf("oshibka videleniya pamyati na ustroystve\n");
        return;
    }
...
__global__ void cycleCounter(bool* grid, int height_d, int width_d, int* cycle_count) {
    ...
    if (grid[i*height + j]) {
        ...
        if (grid[i * height_d + (j + 1 + height_d) % height_d] && grid[((i + 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && grid[((i + 1 + width_d) % width_d) * height_d + j] \
            ...
            && !grid[((i - 1 + width_d) % width_d) * height_d + (j + 2 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + j]) *cycle_count += 1;

        else if (!grid[((i + 1 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + j] && !grid[((i + 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j + 2 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j + 3 + height_d) % height_d] \
            ...
            && !grid[((i - 4 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i - 4 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[((i - 4 + width_d) % width_d) * height_d + j] && !grid[((i - 4 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i - 4 + width_d) % width_d) * height_d + (j + 2 + height_d) % height_d] && !grid[((i - 4 + width_d) % width_d) * height_d + (j + 3 + height_d) % height_d]) *cycle_count += 1;
        ...
        else if (!grid[((i - 2 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[i * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 3 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] \
            ...
            && !grid[((i - 2 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d] && !grid[i * height_d + (j - 4 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d] && !grid[((i + 3 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d]) *cycle_count += 1;
        ...
        else if (!grid[((i - 2 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[i * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] \
            ...
            && !grid[((i - 2 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d] && !grid[i * height_d + (j - 4 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d]) *cycle_count += 1;

        else if (!grid[((i - 2 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[i * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 3 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] \
            && !grid[((i - 2 + width_d) % width_d) * height_d + j] && !grid[((i - 1 + width_d) % width_d) * height_d + j] && grid[i * height_d + j] && grid[((i + 1 + width_d) % width_d) * height_d + j] && !grid[((i + 2 + width_d) % width_d) * height_d + j] && !grid[((i + 3 + width_d) % width_d) * height_d + j] \
            && !grid[((i - 2 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && grid[((i - 1 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[i * height_d + (j - 1 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && grid[((i + 2 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[((i + 3 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] \
            && !grid[((i - 2 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && grid[i * height_d + (j - 2 + height_d) % height_d] && grid[((i + 1 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 3 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] \
            && !grid[((i - 2 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d] && !grid[i * height_d + (j - 3 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d] && !grid[((i + 3 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d]) *cycle_count += 1;

        else if (!grid[((i - 2 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[i * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] \
            && !grid[((i - 2 + width_d) % width_d) * height_d + j] && !grid[((i - 1 + width_d) % width_d) * height_d + j] && grid[i * height_d + j] && !grid[((i + 1 + width_d) % width_d) * height_d + j] && !grid[((i + 2 + width_d) % width_d) * height_d + j] \
            && !grid[((i - 2 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && grid[((i - 1 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[i * height_d + (j - 1 + height_d) % height_d] && grid[((i + 1 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] \
            && !grid[((i - 2 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && grid[i * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] \
            && !grid[((i - 2 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d] && !grid[i * height_d + (j - 3 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d]) *cycle_count += 1;
        ...
        else if (!grid[((i - 3 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i - 2 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[i * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] \
            ...
            && !grid[((i - 3 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d] && !grid[((i - 2 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d] && !grid[i * height_d + (j - 4 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d]) *cycle_count += 1;
        ...
        else if (!grid[((i - 1 + width_d) % width_d) * height_d + (j + 2 + height_d) % height_d] && !grid[i * height_d + (j + 2 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j + 2 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j + 2 + height_d) % height_d] && !grid[((i + 3 + width_d) % width_d) * height_d + (j + 2 + height_d) % height_d] && !grid[((i + 4 + width_d) % width_d) * height_d + (j + 2 + height_d) % height_d] \
            ...
            && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[i * height_d + (j - 1 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && grid[((i + 2 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && grid[((i + 3 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[((i + 4 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] \
            && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[i * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 3 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 4 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d]) *cycle_count += 1;
        ...
        else if (!grid[((i - 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[i * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 3 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 4 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] \
            && !grid[((i - 1 + width_d) % width_d) * height_d + j] && grid[i * height_d + j] && !grid[((i + 1 + width_d) % width_d) * height_d + j] && grid[((i + 2 + width_d) % width_d) * height_d + j] && grid[((i + 3 + width_d) % width_d) * height_d + j] && !grid[((i + 4 + width_d) % width_d) * height_d + j] \
            && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && grid[i * height_d + (j - 1 + height_d) % height_d] && grid[((i + 1 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && grid[((i + 3 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[((i + 4 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] \
            && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[i * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 3 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 4 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d]) *cycle_count += 1;
        ...
        else if (!grid[((i - 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[i * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] \
            ...
            && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d] && !grid[i * height_d + (j - 4 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 4 + height_d) % height_d]) *cycle_count += 1;
        ...
        else if (!grid[((i - 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[i * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] \
            ...
            && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d] && !grid[i * height_d + (j - 3 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d]) *cycle_count += 1;

        else if (!grid[((i - 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[i * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 3 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] \
            ...
            && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[i * height_d + (j - 1 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[((i + 3 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d]) *cycle_count += 1;

        else if (!grid[((i - 2 + width_d) % width_d) * height_d + (j + 3 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j + 3 + height_d) % height_d] && !grid[i * height_d + (j + 3 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j + 3 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j + 3 + height_d) % height_d] \
            && !grid[((i - 2 + width_d) % width_d) * height_d + (j + 2 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j + 2 + height_d) % height_d] && grid[i * height_d + (j + 2 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j + 2 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j + 2 + height_d) % height_d] \
            && !grid[((i - 2 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[i * height_d + (j + 1 + height_d) % height_d] && grid[((i + 1 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j + 1 + height_d) % height_d] \
            && !grid[((i - 2 + width_d) % width_d) * height_d + j] && grid[((i - 1 + width_d) % width_d) * height_d + j] && grid[i * height_d + j] && grid[((i + 1 + width_d) % width_d) * height_d + j] && !grid[((i + 2 + width_d) % width_d) * height_d + j] \
            && !grid[((i - 2 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[i * height_d + (j - 1 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d]) *cycle_count += 1;
            ...
            && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d] && !grid[i * height_d + (j - 3 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d] && !grid[((i + 3 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d] && !grid[((i + 4 + width_d) % width_d) * height_d + (j - 3 + height_d) % height_d]) *cycle_count += 1;
            ...
            && !grid[((i - 2 + width_d) % width_d) * height_d + j] && !grid[((i - 1 + width_d) % width_d) * height_d + j] && grid[i * height_d + j] && grid[((i + 1 + width_d) % width_d) * height_d + j] && grid[((i + 2 + width_d) % width_d) * height_d + j] && !grid[((i + 3 + width_d) % width_d) * height_d + j] \
            && !grid[((i - 2 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && grid[((i - 1 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && grid[i * height_d + (j - 1 + height_d) % height_d] && grid[((i + 1 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] && !grid[((i + 3 + width_d) % width_d) * height_d + (j - 1 + height_d) % height_d] \
            && !grid[((i - 2 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i - 1 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[i * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 1 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 2 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d] && !grid[((i + 3 + width_d) % width_d) * height_d + (j - 2 + height_d) % height_d]) *cycle_count += 1;
...
__global__ void updateGrid(bool* grid, bool* nextGrid, int height_d, int width_d) { // основной алгоритм программы
    int idx = threadIdx.x + blockIdx.x * blockDim.x;
    if (idx >= height_d * width_d) {
        return;
    }
